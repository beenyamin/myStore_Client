            ...
            <div className="flex justify-center">
                  <div className="relative inline-block">
                        ...
                        >
                              ...
                              <div className="relative bg-gray-50 rounded-full p-[10px] border  cursor-pointer">
                                    <h2 data-tooltip-id="my-tooltip-1">
                                          <GoPerson size={20} />
                                    </h2>
                                    <ReactTooltip
                                          id="my-tooltip-1"
                              ...
                              <span className={`duration-100 ${dropdownOpen ? "-scale-y-100" : ""}`}   >  </span>
                        </button>
                        ...
                        <div
                              ...
                              className={`absolute right-0 top-full w-[240px] divide-y divide-stroke overflow-hidden rounded-lg bg-slate-100 dark:divide-dark-3 dark:bg-dark-2 ${dropdownOpen ? "block" : "hidden"}`}  >
