...
const ContactUs = () => {
      return (
            ...
            <>
                  ...
                  <section className= "  mx-auto w-full relative z-10 overflow-hidden  py-10 dark:bg-dark lg:py-[290px] max-w-[1620px] px-4 2xl:px-[230px] 3xl:px-7.5 4xl:px-14">
                                    ...
                                    <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                                          <div className="mb-12 max-w-[570px] lg:mb-0">
                                                ...
                                                <div className="mb-8 flex w-full max-w-[370px]">
                                                      <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary/5 text-secondary sm:h-[70px] sm:max-w-[70px]">
                                                            <svg
                                                                  width="32"
                                                                  height="32"
                                                                  viewBox="0 0 32 32"
